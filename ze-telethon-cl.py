...
try:
    ...
    api_id = '20010787'
    api_hash = 'f9d6679276c359346cf9d732052422fb'
    bot_token = '6652361293:AAGELTZ7U6TX9Jce9_gLISx7LeSgANLGa6o'
    DEVLOO = '6258542488'
    MAX_ACCOUNTS = int('1')
    user_bot = 'oshsisjsbot'
    id_bot = int('6652361293')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6258542488))
